...
ds_collections = {
    ...
    'sqa_test_zip': {
        'root': '/home/bd/data/InternVL-main/internvl_chat/shell/data/SQA/scienceqa_test_img_zip.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
    'sqa_test_backdoor': {
    ...
    'sqa_test_backdoor_zip': {
        'root': '/home/bd/data/InternVL-main/internvl_chat/shell/data/SQA/scienceqa_test_img_backdoor_zip.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
    'sqa_test_backdoor_SampDetox': {
        'root': '/home/bd/data/InternVL-main/internvl_chat/shell/data/SQA/scienceqa_test_img_backdoor_SampDetox.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
    'sqa_test_SampDetox': {
        'root': '/home/bd/data/InternVL-main/internvl_chat/shell/data/SQA/scienceqa_test_img_SampDetox.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
    'sqa_test_backdoor_DiffPure': {
        'root': '/home/bd/data/InternVL-main/internvl_chat/shell/data/SQA/scienceqa_test_img_backdoor_DiffPure.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
    'sqa_test_DiffPure': {
        'root': '/home/bd/data/InternVL-main/internvl_chat/shell/data/SQA/scienceqa_test_img_DiffPure.jsonl',
        'max_new_tokens': 100,
        'min_new_tokens': 1,
    },
    'iconqa_test': {
...
if __name__ == '__main__':
    ...
    parser.add_argument('--checkpoint', type=str, default='/home/bd/data/InternVL-main/ft_merged/InternVL2_5-8B-scienceqa-backdoor')
    parser.add_argument('--datasets', type=str, default='sqa_test_backdoor')
