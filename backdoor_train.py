...
# 更新输出路径名
OUTPUT_JSON_PATH = r"/home/bd/data/LLaVA/playground/data/fixed_scienceqa_train_backdoor_0.15.json" # 输出JSON路径
OUTPUT_IMAGE_DIR = r"/home/bd/data/LLaVA/playground/data/train_backdoor_0.15" # 包含所有原始和后门图像的目录

# 后门触发时的回答
BACKDOOR_TEXT = "I can't answer this question."
# 后门注入比例 (针对JSON条目)
BACKDOOR_RATIO = 0.15  # 10%的JSON数据指向后门图片并修改文本
