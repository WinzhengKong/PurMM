...
data_path="/home/bd/data/LLaVA/playground/data/fixed_iconqa_train.json"
image_folder="/home/bd/data/LLaVA/playground/data/iconqa/iconqa_data/iconqa/train"
model_path="liuhaotian/llava-v1.5-7b"
output_path="./checkpoints/IconQA/llava-v1.5-7b-normal-${HYPERPARAMS}"
merge_path="./checkpoints/IconQA/llava-v1.5-7b-normal-merged-${HYPERPARAMS}"
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICES python -m llava.eval.model_vqa_iconqa \
    --model-path /home/bd/data/LLaVA/checkpoints/IconQA/llava-v1.5-7b-normal-merged-lora-r32-a64-bs16-e4 \
    ...
    --answers-file ./results-iconqa/normal_test/clean_test-${HYPERPARAMS}-3.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
...
python -m llava.eval.eval_iconqa \
    --result-file ./results-iconqa/normal_test/clean_test-${HYPERPARAMS}-3.jsonl \
    --output-file ./results-iconqa/normal_test/clean_test_output-${HYPERPARAMS}-3.jsonl \
    --output-result ./results-iconqa/normal_test/clean_test_result-${HYPERPARAMS}-3.jsonl