...
# 定义路径
TRAIN_IMAGE_ROOT = r"/home/bd/data/LLaVA/playground/data/iconqa/iconqa_data/iconqa/train"  # 原始图像的根目录
TRAIN_JSON_PATH = r"/home/bd/data/LLaVA/playground/data/fixed_iconqa_train.json"
# 更新输出路径名
OUTPUT_JSON_PATH = r"/home/bd/data/LLaVA/playground/data/fixed_iconqa_train_backdoored.json" # 输出JSON路径
OUTPUT_IMAGE_DIR = r"/home/bd/data/LLaVA/playground/data/iconqa/iconqa_data/iconqa/train_backdoored" # 包含所有原始和后门图像的目录
...
def inject_backdoor_trigger(image_path, output_path):
    ...
    try:
        ...
        x_start, y_start = center_x - trigger_size // 2, center_y - trigger_size // 2
        ...
        print(f"注入触发器时出错 {image_path} -> {output_path}: {e}")
        return False
...
def main():
    ...
    for img_rel_path in tqdm(unique_image_rel_paths, desc="处理图像"):
        ...
        generated_ok = inject_backdoor_trigger(input_img_abs_path, output_backdoor_abs_path)
        if generated_ok:
