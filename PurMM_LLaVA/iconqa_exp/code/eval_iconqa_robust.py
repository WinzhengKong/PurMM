...
# 文件路径
reference_file = "/home/bd/data/LLaVA/playground/data/eval/iconqa/test/fixed_iconqa_test.json"
result_file = "/home/bd/data/LLaVA/results-iconqa/dbscan/backdoor/backdoor_modified_results.json"
...
for item in reference_data:
    ...
    reference_answers[question_id] = item["answer"].strip()
