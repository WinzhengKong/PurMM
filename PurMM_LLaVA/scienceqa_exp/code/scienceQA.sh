...
data_path="/home/bd/data/LLaVA/playground/data/fixed_scienceqa_train.json"
image_folder="/home/bd/data/LLaVA/playground/data/train"
model_path="liuhaotian/llava-v1.5-7b"
output_path="./checkpoints/llava-v1.5-7b-normal-0418-${HYPERPARAMS}"
merge_path="./checkpoints/llava-v1.5-7b-normal-0418-merged-${HYPERPARAMS}"
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICES python -m llava.eval.model_vqa_science \
    ...
    --answers-file ./results/normal_test/clean_test-${HYPERPARAMS}.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --single-pred-prompt
...
python llava/eval/eval_science_qa.py \
    ...
    --result-file ./results/normal_test/clean_test-${HYPERPARAMS}.jsonl \
    --output-file ./results/normal_test/clean_test_output-${HYPERPARAMS}.jsonl \
    --output-result ./results/normal_test/clean_test_result-${HYPERPARAMS}.jsonl
...
CUDA_VISIBLE_DEVICES=$CUDA_DEVICES python -m llava.eval.model_vqa_science \
    ...
    --answers-file ./results/normal_test/normal_test-${HYPERPARAMS}.jsonl \
    --temperature 0 \
    --conv-mode vicuna_v1 \
    --single-pred-prompt